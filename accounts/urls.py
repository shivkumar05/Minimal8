...
urlpatterns = [
    ...
    path('user_post_data/<int:pk>/',Post_data.as_view()),
    path('profilepik/<int:pk>/',Profile_data.as_view()),
    path('about/<int:pk>/',About_data.as_view()),
    path('sociale/<int:pk>/',social_data.as_view()),
    path('post/<int:pk>/',Post_data.as_view()),
]