...
class Post(models.Model):
    ...
    is_approved = models.BooleanField(default=False)
    user = models.ForeignKey(settings.AUTH_USER_MODEL,on_delete=models.CASCADE,related_name='userpic',blank=True,default = None,null=True)
...
class Comments(MPTTModel):
    ...
    user = models.ForeignKey(Profile_Pic,on_delete=models.CASCADE,blank=True)
